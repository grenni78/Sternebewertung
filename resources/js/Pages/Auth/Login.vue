<template>
  <jet-authentication-card>
    ...
    <form @submit.prevent="submit">
      ...
      <div class="mt-4">
        <jet-label class="text-white" for="password" value="Passwort" />
        <jet-input
          id="password"
          type="password"
          class="mt-1 block w-full"
      ...
      <div class="block mt-4">
        <label class="flex items-center">
          ...
          <span class="ml-2 text-sm text-white">angemeldet bleiben</span>
        </label>
      </div>
      ...
      <div class="flex items-center justify-end mt-4">
        <inertia-link
          ...
          class="underline text-sm text-white hover:text-indigo-100"
        >
          Passwort vergessen?
        </inertia-link>
      ...
      <div class="flex items-end justify-end mt-2">
        <inertia-link
          :href="route('register')"
          class="underline text-sm text-gray-600 hover:text-white"
        >
