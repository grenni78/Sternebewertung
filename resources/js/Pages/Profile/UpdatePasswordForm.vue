<template>
  <jet-form-section @submitted="updatePassword">
    ...
    <template #description>
      Bitte verwenden Sie ein langes, mit Sonderzeichen und Zahlen versehenes
      Kennwort.
    </template>

    <template #form>
      <div class="col-span-6 sm:col-span-4">
        <jet-label for="current_password" value="Aktuelles Passwort" />
        <jet-input
          id="current_password"
          type="password"
      ...
      <div class="col-span-6 sm:col-span-4">
        <jet-label
          ...
          value="Wiederholung des neuen Passwortes"
        />
        <jet-input
